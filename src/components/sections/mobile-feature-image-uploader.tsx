...
export default function MobileFeatureImageUploader() {
        ...
        setDoc(configDocRef, { mobileFeatureImageUrl: dataUrl }, { merge: true })
          .then(async () => {
            ...
            toast({
                ...
                description: "Mobile feature image has been updated.",
            });
            setFile(null);
          })
          .catch(error => {
        ...
        >
            ...
            {preview ? (
                ...
                <div className="text-center text-muted-foreground p-4">
                    ...
                    <p className="text-xs mt-1">Recommended for vertical images</p>
                </div>
            )}
        </div>
        {file && !isProcessing && (
